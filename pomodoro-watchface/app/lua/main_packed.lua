...
local u={}
local function B(d)if hv and vb then pcall(vb.start,{duration=d})end end
...
u.rd:set{text="RND "..S.rd,text_color=t.c}
end
local function nx()
if S.md<1 then
S.rd=S.rd+1
...
u.rd=L.Label(r,{text="RND 0",text_color=0xe05252,text_font=L.Font("MiSans-Regular",16,"normal"),align={type=L.ALIGN.CENTER,y_ofs=58}})
